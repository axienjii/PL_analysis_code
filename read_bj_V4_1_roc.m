...
if excludeSessHighSSE==1
    ...
    if excludeOutliers==1   %within reduced pool of sessions with good SSE, further examine slope and C50 values for outliers
        ...
        c50outliersHighcut=abs((c50-mean(c50)))>10000;%manual exclusion for obvious outliers
%         if sum(c50outliersHighcut)>0
%             pause
%         end
        ind=sloutliers+c50outliers+c50outliersHighcut;%find sessions where slope and/or C50 values are outliers (union)
