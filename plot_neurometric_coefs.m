function plot_neurometric_coefs(animal,area,chNum,appendText,startEndTime,slopeNeuro,c50,plotDiffC50_30,diffc50,minRate,maxRate,sessionSorted1,analysisTypeText,example_ch_54,excludeSessHighSSE,excludeOutliers,writeCoefs,slSigmaMultiple,c50SigmaMultiple,calcPartial)
...
if calcPartial==2
    ...
    [coefficients1(2) p1(2)]=partialcorr(slopeNeuro',sessionSorted1',[c50' minRate' maxRate']);
    [coefficients2(2) p2(2)]=partialcorr(c50',sessionSorted1',[slopeNeuro' minRate' maxRate']);
    [coefficients3(2) p3(2)]=partialcorr(slopeNeuro',matchPsycho',[c50' minRate' maxRate']);
    [coefficients4(2) p4(2)]=partialcorr(diffc50',sessionSorted1',[slopeNeuro' minRate' maxRate']);
    [coefficients5(2) p5(2)]=partialcorr(minRate',sessionSorted1',[slopeNeuro' c50' maxRate']);
    [coefficients6(2) p6(2)]=partialcorr(maxRate',sessionSorted1',[slopeNeuro' c50' minRate']);
end
...
if length(slopeNeuroFinal)>=0.8*length(sessionSorted1)
    if calcPartial==1
        %partial correlations for just slope and PNE:
        [coefficients1(2) p1(2)]=partialcorr(slopeNeuroFinal',sessionSorted1Final',c50Final');
        [coefficients2(2) p2(2)]=partialcorr(c50Final',sessionSorted1Final',slopeNeuroFinal');
    end
