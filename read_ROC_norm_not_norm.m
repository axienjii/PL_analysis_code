function read_ROC_norm_not_norm(cutoff,excludeSuppressed)
...
%to maximum firing rates of individual channels. Performs comparison of values of 4
%params calculated by bj_cumulatice_roc_diff, using AUROC curves that were
%generated by the trial-wise method (not by the traditional method).
analysisType='ROC';
...
for areaInd=1:length(areas)
    ...
    for animalInd=1:length(animals)
        ...
        subFolder=[subFolder,'_normalised'];%read normalised data
        loadText=['load ',rootFolder,'\PL\',analysisType,'\',animal,'\',subFolder,'\cumulative_ROCs_old_new_',area,'_30_cutoff',num2str(cutoff*10),'.mat slopeNeuroNew PNENew minRateNew maxRateNew'];  
        eval(loadText)
