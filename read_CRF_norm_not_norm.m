function read_CRF_norm_not_norm(cutoff,excludeSuppressed,plotErrorBars,roving,normaliseSpontan,excludeNonmonotonic)
...
if roving==1
    ...
    elseif newColCode==1
        ...
        subplot(4,2,2)
        ylim([0 0.7])
        set(gca,'YTick',[0 0.7],'YTickLabel',[0 0.7]);
        subplot(4,2,3)
        ylim([10 70])
        set(gca,'YTick',[10 70],'YTickLabel',[10 70]);
        subplot(4,2,4)
        ylim([20 60])
        set(gca,'YTick',[20 60],'YTickLabel',[20 60]);
        subplot(4,2,5)
        ylim([0 17])
        set(gca,'YTick',[10 17],'YTickLabel',[10 17]);
        subplot(4,2,6)
        ylim([6 15])
        set(gca,'YTick',[6 15],'YTickLabel',[6 15]);
        subplot(4,2,7)
        ylim([0 30])
        set(gca,'YTick',[0 30],'YTickLabel',[0 30]);
        subplot(4,2,8)
        ylim([10 50])
        set(gca,'YTick',[10 50],'YTickLabel',[10 50]);
        subplot(4,2,2);
        ...
        xlim([0 17]);
        ylim([20 50]);
        set(gca,'YTick',[20 50],'YTickLabel',[20 50]);
        subplot(4,2,5);
        xlim([0 35]);
        subplot(4,2,6);
        xlim([0 17]);
        ylim([6 14]);
        set(gca,'YTick',[6 14],'YTickLabel',[6 14]);
        subplot(4,2,7);
        xlim([0 35]);
        ylim([0 25]);
        subplot(4,2,8);
