...
crfPathname=fullfile('F:','PL','CRF',animal,'neurometric_CRF',crfImagename);
crfFolder=fullfile('F:','PL','CRF',animal,'neurometric_CRF');
...
if length(coefficients1)>1
    ...
    crfCoefFolder=fullfile('F:','PL','CRF',animal,'CRF_coef_images');
    ...
    if writeCoefs==1
        ...
        crfCoefMatFolder=fullfile('F:','PL','CRF',animal,'CRF_coef_mat');
