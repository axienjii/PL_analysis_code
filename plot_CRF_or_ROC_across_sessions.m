                ...
                for iC50 = 1 : 4                    
                    ...
                    for iSlope = 0.5 : stepSize : maxSlope                        
                        ...
                        if strcmp(analysisType,'psycho')
                            [coefEsts2(InitVar,:),fval2(InitVar)]=fminsearch(@weibull_pointfive_one,X0,options,testContrastSplit{higherOrLower},datavalsSplit{higherOrLower},[1 1],[maxDiff(higherOrLower) 10],[1 1],[0 0]);%place upper limit on threshold value, depending on whether examining higher or lower test contrast conds
