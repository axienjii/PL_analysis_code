function [err] = fit_logistic(p,conditions,response,standard_dev,err_type,var_max_limit,max_limit,var_min_limit,min_limit)
...
offset = response - (1./(1+10.^(-p(1).*(conditions-p(2)))));
